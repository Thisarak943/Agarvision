...
export default function SafetyShoesContents() {
    return (
        <>
            ...
            <Text className="text-gray-700 leading-6 mb-4">
                Global is an official international distributor for VF Imagewear, Inc. The brands we represent include Red Kap, Horace Small, Bulwark and Wrangler. If needed, we can also provide customization of your garments.Please email your inquiries to exports@gtim.com
            </Text>
