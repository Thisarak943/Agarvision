    ...
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <ScrollView className="flex-1 px-6 py-4" showsVerticalScrollIndicator={false}>
        <View className="bg-white rounded-2xl border border-gray-200 p-5 mb-4">
          <Text className="text-lg font-bold text-gray-900 mb-2">Resin Grading Module</Text>
          <Text className="text-gray-600">
            This page will be connected to your Resin Grading backend + model next month.
          </Text>
        </View>
